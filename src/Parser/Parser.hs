...
happyExpList = Happy_Data_Array.listArray (0,43) ([96,64,2048,0,1920,0,14336,96,96,96,96,96,96,96,0,4096,0,1536,1536,16384,1920,0,0,0
	])
...
action_8 (5) = happyGoto action_20

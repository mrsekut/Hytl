...
happyExpList = Happy_Data_Array.listArray (0,96) ([448,64,7,1,0,40448,15,0,6144,2,0,28672,0,0,0,63968,16386,8,112,49152,1,1792,0,28,28672,0,448,0,7,7168,0,112,49152,1,1792,0,28,0,30,30720,0,480,32768,7,7680,0,0,0,0,1536,0,24,30720,63,63968,32768,999,112,0,15992,1,0,28,0,3998,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","Program","Stmt","Exp","int","var","bool","'='","\"=>\"","'+'","'-'","'*'","'/'","'('","')'","\"==\"","'>'","\">=\"","'<'","\"<=\"","\"if\"","\"then\"","\"else\"","%eof"]
        bit_start = st * 26
        bit_end = (st + 1) * 26
...
action_9 (18) = happyShift action_18
...
action_9 (24) = happyShift action_35
...
action_11 (6) = happyGoto action_34
...
action_14 (6) = happyGoto action_31
...
action_23 (15) = happyShift action_17
...
action_38 (8) = happyShift action_10
...
action_39 (19) = happyShift action_19
